...
# suffixes = list(np.arange(4,15)*250)
# dataset_dictionaries4 = []
# for suf in suffixes:
#     dataset_dictionaries4.append(get_1toN_x(suf))


                             
#all_dataset_dicts = dataset_dictionaries4 # + dataset_dictionaries1 + dataset_dictionaries2 + dataset_dictionaries3

all_dataset_dicts = [get_SVD_x(1000), get_SVD_x(1000)]
...
for data in all_dataset_dicts:
    ...
    model = SimpleMLP2(inp_size, 2048*8, 2048*8, OUT_SIZE)
